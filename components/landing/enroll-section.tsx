          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <ScrollReveal animation="slide-in-right">
              <div className="space-y-6" dir="rtl">
                <div className="p-8 rounded-2xl bg-card border-2 border-primary/20 shadow-xl">
                  <h3 className="text-2xl font-bold mb-6">ما ستحصل عليه:</h3>
                  <ul className="space-y-4">
                    {[
                      "برنامج تدريبي متكامل جاهز للمكتب",
                      "مدربون معتمدون Double Certified",
                      "ضمان استرداد الأموال لمدة 14 يوماً",
                ...
                <div className="p-6 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-semibold text-lg">ضمان 14 يوم</span>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    إذا لم تكن راضياً عن البرنامج خلال أول 14 يوم، سنعيد لك أموالك بالكامل بدون أي أسئلة.
                  </p>
                </div>
              </div>
            </ScrollReveal>
                ...
                <div className="relative p-8 md:p-10 rounded-2xl bg-card border-2 border-primary/20 shadow-2xl" dir="rtl">
                  {isSubmitted ? (
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-2xl font-bold mb-4">شكراً لك!</h3>
