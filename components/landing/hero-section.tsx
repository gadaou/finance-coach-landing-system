...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-primary/5 to-background pt-8">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-6xl mx-auto text-center space-y-8 py-8" dir="rtl">
          ...
          <ScrollReveal animation="fade-in-up" delay={300}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              ...
              <div className="flex items-center gap-2 px-4 py-2 bg-muted/50 rounded-lg border border-border">
                ...
                <span className="text-sm font-medium">ضمان استرداد الأموال لمدة 14 يوماً</span>
              </div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal animation="fade-in-up" delay={400}>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-12">
              {[
                ...
                { icon: Award, number: "Double", label: "معتمد", sublabel: "CFA + FMVA" },
                { icon: CheckCircle2, number: "14", label: "يوم ضمان", sublabel: "استرداد الأموال" },
              ].map((stat, index) => (
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="text-3xl md:text-4xl font-bold text-primary mb-2 group-hover:scale-110 transition-transform duration-300 inline-block">
          {number}
        </div>
