  ...
  return (
    <section className="pt-4 pb-24 bg-gradient-to-br from-background via-primary/5 to-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-20 w-48 h-48 md:w-96 md:h-96 bg-primary/5 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-20 left-20 w-48 h-48 md:w-96 md:h-96 bg-primary/10 rounded-full blur-3xl animate-pulse delay-1000" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-12 max-w-7xl mx-auto items-center">
...
function AnimatedSalaryChart() {
  ...
  return (
    <div ref={chartRef} className="p-4 md:p-8 rounded-2xl bg-card border border-border shadow-xl">
      <div className="mb-4 md:mb-8">
        <h3 className="text-xl md:text-2xl font-bold mb-2">Average Salary Growth</h3>
        <p className="text-sm md:text-base text-muted-foreground">ACCA qualified professionals</p>
      </div>

      <div className="relative h-64 md:h-80 pb-4">
        {/* Y-axis labels */}
        <div className="absolute left-0 top-0 bottom-4 flex flex-col justify-between text-xs md:text-sm text-muted-foreground">
          <span>$150K</span>
          <span>$100K</span>
          <span>$50K</span>
          <span>$0K</span>
        ...
        {/* Chart area */}
        <div className="ml-10 md:ml-16 h-[calc(100%-1rem)] flex items-end justify-between gap-2 md:gap-4">
          {data.map((item, index) => (
            <div key={index} className="flex-1 flex flex-col items-center group cursor-pointer">
              ...
              <div className="relative w-full mb-4">
                ...
                >
                  ...
                  {/* Salary label */}
                  <div className="absolute -top-8 md:-top-10 left-1/2 -translate-x-1/2 bg-primary text-primary-foreground px-2 md:px-3 py-1 rounded-lg text-xs md:text-sm font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity z-10">
                    ${item.salary}K
                  </div>
                </div>
              </div>
              ...
              <div className="text-center">
                <div className="text-xs md:text-sm font-semibold mb-1">{item.year}</div>
                <div className="text-[10px] md:text-xs text-muted-foreground whitespace-nowrap">{item.label}</div>
              </div>
            </div>
          ))}
        </div>
...
function CareerMilestone({
  ...
  return (
    ...
    >
      <div className="bg-card rounded-2xl p-4 md:p-6 flex items-center gap-3 md:gap-4 relative overflow-hidden">
        {/* Animated background on hover */}
        <div className="absolute inset-0 bg-gradient-to-r from-primary/0 via-primary/10 to-primary/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />

        <div className="relative p-3 md:p-4 rounded-xl bg-primary/10 text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-300 group-hover:rotate-12 group-hover:scale-110">
          <Icon className="h-6 w-6 md:h-8 md:w-8" />
        </div>
        <div className="flex-1 relative z-10">
          <h4 className="text-base md:text-lg font-bold mb-1">{title}</h4>
          <div className="text-xl md:text-2xl font-bold text-primary">{salary}</div>
        </div>
      </div>
    </div>
  )
